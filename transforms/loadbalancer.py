...
class LoadBalancer(InfrahubTransform):
    ...
    async def transform(self, data: Any) -> Any:
        ...
        if not lb_data:
            raise ValueError("No OnpremLoadbalancer data found in response")
        ...
        for vip_service in vip_services:
            ...
            for server in onprem_servers:
                ...
                server_ip = (server.get("ip_address") or {}).get("address", "").split("/")[0]
        ...
        management_ip = "192.168.1.100"  # Placeholder - OnpremLoadbalancer doesn't have interfaces

        # Extract device information from OnpremLoadbalancer
        ...
        lb_data["loadbalancer_config"] = {
            ...
            "stats_user": lb_data.get("stats_user", "admin"),
            "stats_password": lb_data.get("stats_password", "CHANGE_ME"),
            "global_maxconn": 4096,
        ...
        # Use lb_vendor to select the appropriate template for OnpremLoadbalancer
