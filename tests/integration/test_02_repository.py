...
class TestRepository(TestInfrahubDockerWithClient):
    ...
    @pytest.mark.order(6)
    @pytest.mark.dependency(scope="session", name="add_repository", depends=["bootstrap_data"])
    @pytest.mark.asyncio
    ...
    @pytest.mark.order(7)
    @pytest.mark.dependency(scope="session", name="repository_sync", depends=["add_repository"])
    @pytest.mark.asyncio
    ...
    @pytest.mark.order(8)
    @pytest.mark.dependency(scope="session", name="events_data", depends=["repository_sync"])
